...
function VideoPlayer() {
	...
	if (currentVideo && videos.length) {
		...
		return (
			<Paper square variant="outlined" component={Box} position="fixed" bottom="15px" right="15px" height="300px">
				<Box display="flex" height="100%">
					...
					{videos.length && (
						<Box display="flex" flexDirection="column" height="100%" width="200px" style={{ backgroundColor: "#212121" }}>
							...
							<List disablePadding flexGrow={1} style={{ overflow: "auto" }}>
								{videos.map(v => (
